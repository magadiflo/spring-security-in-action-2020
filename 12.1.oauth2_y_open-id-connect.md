...
- [Fuente: ID Token and Access Token: What Is the Difference?](https://auth0.com/blog/id-token-access-token-what-is-the-difference/)
- [Fuente: ID Tokens vs Access Tokens](https://oauth.net/id-tokens-vs-access-tokens/)
